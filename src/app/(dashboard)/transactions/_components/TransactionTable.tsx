...
import type { GetTransactionHistoryType } from "@/app/api/transactions-history/route";
...
export default function TransactionTable({ from, to }: Props) {
	...
	const query = useQuery<GetTransactionHistoryType>({
	...
	return (
		<div className="w-full container mx-auto">
			...
			<SkeletonWrapper isLoading={query.isFetching} fullWidth>
			...
			<DropdownMenu>
				...
				<DropdownMenuContent align="end">
					...
					<DropdownMenuItem
						...
						onSelect={() => setShowDelete((prev) => !prev)}
					>
						<TrashIcon className="h-4 w-4 text-red-500 group-hover:text-red-600" />
						<span className="capitalize text-red-500 group-hover:text-red-600">
							Delete
						</span>
					</DropdownMenuItem>
				</DropdownMenuContent>
