		...
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				{trigger ? (
					...
					<Button
						variant={"ghost"}
						className="border-separate items-center justify-start rounded-none border-b px-3 py-3 text-muted-foreground"
					>
			...
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>
						Transactions are grouped by their Categories
					</DialogDescription>
				</DialogHeader>
				<Form {...form}>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>
										Appearance of the category in the application
									</FormDescription>
								</FormItem>
							)}
						/>
